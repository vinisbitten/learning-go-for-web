...
func ListPosts(w http.ResponseWriter, r *http.Request) {
	...
	t := template.Must(template.ParseFiles("template/layout.html", "template/list.html"))
...
func ViewPost(w http.ResponseWriter, r *http.Request) {
	...
	t := template.Must(template.ParseFiles("template/layout.html", "template/view.html"))
